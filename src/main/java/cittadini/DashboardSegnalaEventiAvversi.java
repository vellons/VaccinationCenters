...
public class DashboardSegnalaEventiAvversi {
     ...
     */
    public DashboardSegnalaEventiAvversi() throws IOException {
    ...
    private void $$$setupUI$$$() throws IOException {
        createUIComponents();
        panelNewReport = new JPanel();
        panelNewReport.setLayout(new GridLayoutManager(3, 2, new Insets(10, 10, 10, 10), -1, -1));
        panelNewReport.setBackground(new Color(-723724));
        panelNewReport.setPreferredSize(new Dimension(1000, 600));
        panelNewReport.setVisible(true);
        panelLogo.setBackground(new Color(-723724));
        panelNewReport.add(panelLogo, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_NORTHWEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, new Dimension(-1, 200), 0, false));
        panelListaNuoveSegnalazioni.setBackground(new Color(-723724));
        panelListaNuoveSegnalazioni.setEnabled(true);
        panelListaNuoveSegnalazioni.setForeground(new Color(-723724));
        panelListaNuoveSegnalazioni.setVisible(true);
        panelNewReport.add(panelListaNuoveSegnalazioni, new GridConstraints(0, 0, 3, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_VERTICAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new GridLayoutManager(2, 1, new Insets(0, 0, 0, 0), -1, -1));
        panel1.setBackground(new Color(-723724));
        panelNewReport.add(panel1, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        btnInviaSegnalazione = new JButton();
        btnInviaSegnalazione.setActionCommand("Invia segnalazione");
        btnInviaSegnalazione.setBackground(new Color(-3727837));
        btnInviaSegnalazione.setBorderPainted(false);
        btnInviaSegnalazione.setEnabled(true);
        btnInviaSegnalazione.setFocusPainted(false);
        btnInviaSegnalazione.setFocusable(false);
        btnInviaSegnalazione.setForeground(new Color(-1));
        btnInviaSegnalazione.setLabel("Invia segnalazione");
        btnInviaSegnalazione.setOpaque(true);
        btnInviaSegnalazione.setText("Invia segnalazione");
        btnInviaSegnalazione.setVisible(true);
        panel1.add(btnInviaSegnalazione, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(250, -1), new Dimension(250, -1), 0, false));
        lbInfo = new JLabel();
        Font lbInfoFont = this.$$$getFont$$$(null, Font.ITALIC, -1, lbInfo.getFont());
        if (lbInfoFont != null) lbInfo.setFont(lbInfoFont);
        lbInfo.setForeground(new Color(-16777216));
        lbInfo.setText("<html>Lo slider permette di specificare<br> la severità di ogni evento avverso presente nella lista.<br> \nPer poter inserire una nota, modificare<br> il valore della severità tramite l'uso dello slider.<br>\nSe la severità di un evento avverso è 0, <br>esso non verrà preso in considerazione al momento del<br> caricamento.</html>");
        panel1.add(lbInfo, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
